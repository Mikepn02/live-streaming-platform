...
const ChallengeContent = () => {
    return (
        <div className="">
            <div className="md:space-x-2 md:mt-8 flex w-full">
                <Slide3 />
            </div>
            <h1 className='font-semibold text-xl mt-10'>User's post</h1>
            <div className='w-full'>

                <div className='flex flex-wrap gap-16 mt-5'>
                    <div className='bg-gradient-to-r from-[#E179CB] via-[#DCAB8D] to-[#D7DF4D] mt-5 rounded-[20px] w-1/4 h-60 flex flex-col items-center justify-center text-white'>
