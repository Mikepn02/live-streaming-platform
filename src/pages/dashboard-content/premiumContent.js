    ...
    return (
        <div className='md:mr-32 mr-5'>
            ...
            <div className='flex md:flex-row flex-col gap-14 md:mt-36 mt-4 justify-center items-center'>
                    <div className='flex-col md:h-[55vh]  md:w-[350px] w-full h-auto border-2 border-[#DBDBDB] p-4'>
                ...
                <div className='flex-col md:h-[55vh] p-4 md:w-[350px] w-full text-white h-auto bg-gradient-to-r from-[#E179CB] via-[#DCAB8D] to-[#D7DF4D]  '>
                    <div className='flex flex-row items-center justify-center space-x-2'>
                ...
                <div className='flex-col md:h-[55vh] p-4 md:w-[350px] w-full h-auto border-2 '>
                    <div className='flex flex-row items-center justify-center space-x-2'>
