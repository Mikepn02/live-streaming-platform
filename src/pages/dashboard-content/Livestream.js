        ...
        <div className='stream-bg flex flex-row justify-between w-full h-[100vh]'>
            <div className='flex flex-col w-1/2 justify-between'>
                ...
                <div className='p-10 space-y-5'>
                    ...
                    <p className=' text-white w-2/4'>IShowSpeed · bald · Videos · Subsrube to my 2nd channel on YT · Popular videos · Shorts · i might die bye · I Met Neymar · Eu Prado No Bailo With Neymar .</p>
                ...
                <div className='p-5 gap-10'>
                    ...
                    <div className='flex justify-end items-center mt-4 space-x-8'>
                        <div className='relative'>
                            <div className='bg-white opacity-[17%] absolute inset-0 rounded-full p-2 w-16 h-16'></div>
