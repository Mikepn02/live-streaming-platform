...
const SettingContent = () => {
    return (
        <div className='mt-5 space-y-2 w-[95vw]'>
            <h1 className='text-[#F3A5E3] text-3xl font-bold'>Setting</h1>
            <h1 className='mt-4 text-2xl font-bold'>Your account</h1>
            <div className='flex flex-col gap-10 md:flex-row'>
                <div className='flex  flex-row space-x-4 items-center justify-between shadow-xl text-black w-full md:w-[30vw]  p-4 rounded-[10px] bg-blue-500'>
                ...
                <div className='flex space-x-4 items-center justify-between shadow-xl text-black w-full md:w-[30vw] p-4 rounded-[10px] bg-blue-500'>
                    <div className="flex space-x-4 items-center">
            ...
            <div className='flex flex-col gap-10 md:flex-row'>
                ...
                <div className='flex space-x-4 items-center justify-between shadow-xl text-black w-full md:w-[30vw] p-4 rounded-[10px] bg-blue-500'>
                    <div className='flex flex-col gap-10 md:flex-row'>
                        <img src='/assets/paper.svg' alt='account' width={24} height={24}/>
                        <div>
            ...
            <button className='bg-gradient-to-r from-[#E179CB] via-[#DCAB8D] to-[#D7DF4D] md:w-48 w-full  h-14 rounded-[10px] text-white font-semibold'>Reset all settings</button>
        </div>
    )
}
