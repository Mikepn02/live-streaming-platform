...
const Followers = () => {
  return (
    <div>
        <div className='justify-center flex flex-col mt-[100px] text-center bg-[#F0F0F0] w-full h-32 text-2xl p-10'>
       <p className='px-10'>
        over <span className='text-[#E179CB] font-bold'>500,000</span> </p>
        <p> Live streamers using our app and make money</p>
    </div>
   ...
   <p className='px-auto md:w-[60vw] w-full'>
       ...
       and shared experience. One intriguing aspect of live streams is the ability for viewers to express their appreciation through virtual gifts. 
