...
const Cards = () => {
  return (
    <div className='md:flex md:flex-row flex-col  justify-center w-full md:w-[60%] md:gap-6 gap-10  items-center md:mx-auto mt-10 mb-10'>
      <div className="border-2 border-[#E179CB] md:w-1/3 rounded-[10px] p-5">
        ...
        <button className="text-black bg-gradient-to-r from-[#E179CB] via-[#DCAB8D] to-[#D7DF4D] md:w-32 w-full h-10 md:h-[4vh] rounded-full mt-4 md:mt-5  md:mb-5">
          Get Started
        </button>
      </div>
      <div className="border-2 border-[#E179CB] md:w-1/3 rounded-[10px] p-5">
