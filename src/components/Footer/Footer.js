...
const Footer = () => {
    return (
        <footer>
            <div className="container   w-full grid grid-cols-1 gap-4 xl:gap-16 md:grid-cols-4 px-10 md:p-10 p-8 space-y-10 md:space-y-0 space-x-4 mx-auto">
                <div className=" tems-center  justify-center text-center md:text-left space-y-8">
                ...
                <div className=" items-center  w-full justify-center text-center md:text-left space-y-4 ">
